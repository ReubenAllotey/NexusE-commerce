  ...
  return rows
    .map((row) => {
      ...
      return {
        ...
        shippingFee: product.shippingFee ?? product.shipping_fee ?? null,
        shippingFeeStatus: product.shippingFeeStatus ?? product.shipping_fee_status ?? (product.shippingFee == null ? "pending" : "ready"),
        availabilityType,
